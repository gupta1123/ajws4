// src/components/bulk-import/parent-import.tsx
...
export function ParentImport() {
  const [isDragging, setIsDragging] = useState(false);
  const [previewData, setPreviewData] = useState<ParentData[]>([]);
      ...
      const mockData: ParentData[] = [
        {
          ...
          studentAdmissionNumber: '2025001'
        },
        {
          fullName: 'Manoj Nair',
          ...
          studentAdmissionNumber: '2025002'
        }
      ];
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle>Bulk Parent Import</CardTitle>
          <CardDescription>
        ...
        <CardContent>
          {importStatus === 'idle' || importStatus === 'uploading' || importStatus === 'error' ? (
            <div className="space-y-4">
              ...
              <div className="text-sm text-gray-500">
                ...
                <ul className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  ...
                  <li>Address</li>
                  <li>Student Name</li>
                  <li>Student Admission Number</li>
                </ul>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-end gap-2">
                ...
                <Button onClick={handleImport}>
                  Import {previewData.length} Parents
                </Button>
              </div>
            </div>
            ...
            <div className="text-center py-8">
              ...
              <p className="mt-4 font-medium">Importing parents...</p>
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-500 mt-2">
                {previewData.length} parents have been successfully imported.
              </p>
              <div className="mt-6">
      ...
      {previewData.length > 0 && importStatus === 'preview' && (
        <ImportPreview data={previewData} type="parents" />
      )}
    </div>
  );
}